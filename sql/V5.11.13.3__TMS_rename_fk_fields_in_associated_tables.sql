...
ALTER TABLE `tms_requirenment_tms_test_assoc` CHANGE `requirenment_id` `tms_requirenment_id` mediumint(9) unsigned NOT NULL;
ALTER TABLE `tms_requirenment_tms_test_assoc` CHANGE `test_id` `tms_test_id` mediumint(9) unsigned NOT NULL;
