...
class TMS_Views_TestRunTemplate extends Pluf_Views
{
     ...
     * @return TMS_TestRunTemplate
     */
    public function create($request, $match)
    {
        // initial content data
        $extra = array(
            'model' => new TMS_TestRunTemplate()
        );
    ...
    {
        // GET data
        $item = Pluf_Shortcuts_GetObjectOr404('TMS_TestRunTemplate', $match['modelId']);
        // Do
