 ...
 */
class REST_TestAttachmentTest extends REST_AbstractTest
{
    ...
    public function getsSchemaOfAProject()
    {
        ...
        $response = $client->get('/api/v2/tms/test-attachments/schema');
    ...
    {
        $client = new Test_Client(self::getApiV2());
        $response = $client->get('/api/v2/tms/test-attachments');
        $this->assertNotNull($response);
        $this->assertEquals($response->status_code, 200);
    }
    ...
    public function gettingListOfProjectsByGraphQLTest()
    {
        ...
        // 2- getting list of projects
        $response = $client->get('/api/v2/tms/test-attachments', array(
    ...
    public function createATestWithAdminTest()
    {
        ...
        $response = $client->post('/api/v2/tms/test-attachments', $data);
        Test_Assert::assertNotNull($response);
        Test_Assert::assertEquals($response->status_code, 200);
    }
    ...
    public function deleteATestWithAdminTest()
    {
        ...
        $response = $client->post('/api/v2/tms/test-attachments/' . $id, array(
            'graphql' => '{id,test{id},test_id}'
        ));
        Test_Assert::assertNotNull($response);
        Test_Assert::assertEquals($response->status_code, 200);

        $response = $client->delete('/api/v2/tms/test-attachments/' . $id);
        Test_Assert::assertNotNull($response);
        Test_Assert::assertEquals($response->status_code, 200);

        $test = new TMS_TestAttachment();
