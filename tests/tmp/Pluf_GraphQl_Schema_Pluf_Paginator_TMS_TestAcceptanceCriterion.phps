 ...
 */
class Pluf_GraphQl_Schema_Pluf_Paginator_TMS_TestAcceptanceCriterion {
    public function render($rootValue, $query) {
        // render object types variables
         $TMS_TestAcceptanceCriterion = null;
         $TMS_Test = null;
         $TMS_Project = null;
         $User_Account = null;
         $User_Group = null;
        ...
        // render code
         //
        $TMS_TestAcceptanceCriterion = new ObjectType([
            'name' => 'TMS_TestAcceptanceCriterion',
            'fields' => function () use (&$TMS_Test){
                return [
                    ...
                    //metric: Array(    [type] => Pluf_DB_Field_Varchar    [size] => 64    [is_null] =>     [editable] => 1    [readable] => 1)
                    'metric' => [
                        'type' => Type::string(),
                        'resolve' => function ($root) {
                            return $root->metric;
                    ...
                    //bound: Array(    [type] => Pluf_DB_Field_Float    [is_null] =>     [editable] => 1    [readable] => 1)
                    'bound' => [
                        'type' => Type::float(),
                        'resolve' => function ($root) {
                            return $root->bound;
                    ...
                    //bound_type: Array(    [type] => Pluf_DB_Field_Varchar    [size] => 128    [is_null] =>     [default] => upper    [editable] => 1    [readable] => 1)
                    'bound_type' => [
                        'type' => Type::string(),
                        'resolve' => function ($root) {
                            return $root->bound_type;
                        },
                    ],
                    //severity: Array(    [type] => Pluf_DB_Field_Varchar    [size] => 64    [is_null] =>     [default] => passed    [editable] => 1    [readable] => 1)
                    'severity' => [
                        'type' => Type::string(),
                        'resolve' => function ($root) {
                    ...
                    //duration: Array(    [type] => Pluf_DB_Field_Float    [is_null] =>     [editable] => 1    [readable] => 1)
                    'duration' => [
                        'type' => Type::float(),
                        'resolve' => function ($root) {
                    ...
                    //duration_type: Array(    [type] => Pluf_DB_Field_Varchar    [size] => 128    [is_null] =>     [default] => second    [editable] => 1    [readable] => 1)
                    'duration_type' => [
                        'type' => Type::string(),
                        'resolve' => function ($root) {
                            return $root->duration_type;
                        },
                    ],
                    //Foreinkey value-test_id: Array(    [type] => Pluf_DB_Field_Foreignkey    [model] => TMS_Test    [name] => test    [graphql_name] => test    [graphql_field] => 1    [relate_name] => acceptanceCriteria    [is_null] =>     [editable] => 1    [readable] => 1)
                    'test_id' => [
                            'type' => Type::int(),
                            'resolve' => function ($root) {
                                return $root->test_id;
                    ...
                    //Foreinkey object-test_id: Array(    [type] => Pluf_DB_Field_Foreignkey    [model] => TMS_Test    [name] => test    [graphql_name] => test    [graphql_field] => 1    [relate_name] => acceptanceCriteria    [is_null] =>     [editable] => 1    [readable] => 1)
                    'test' => [
                            'type' => $TMS_Test,
                            'resolve' => function ($root) {
        ...
        ]);$itemType =$TMS_TestAcceptanceCriterion;$rootType =new ObjectType([
            'name' => 'Pluf_paginator',
